...
*/
    ...
    const icon_list = array(
            ...
            "batiment" => array(
                "institut" => "fa fa-institution",
                "bank" => "fa fa-bank",
                "capitol" => "ra ra-capitol",
                "building" => "fa fa-building",
                "building 2" => "fa fa-building-o",
                "maison" => "fa fa-home",
                "tour" => "ra ra-tower",
            ...
            "competence" => array(
                ...
                "spinning-sword" => "ra ra-spinning-sword",
                "bolt-shield" => "ra ra-bolt-shield"

            ),
            "consommable" => array(

                /*"bottle" => "ra ra-heart-bottle",
                "flask" => "ra ra-round-bottom-flask",
                "flask 2" => "fa fa-flask",
                "seringue" => "ra ra-syringe",
                "vase" => "ra ra-vase",*/
            ...
            "mains" => array(
                ...
                "language" => "fa fa-sign-language",
                "mitten" => "fas fa-mitten",
            ),
            "metaux" => array(

                "lingot" => "ra ra-gold-bar"
            ),
            "pieds" => array(

                "boot-stomp" => "ra ra-boot-stomp",
                "semelle" => "ra ra-shoe-prints",
                "nus" => "ra ra-footprint",
            ),
            "plantes" => array(
            ...
            "statut" => array(
                ...
                "aura" => "ra ra-aura" ,
                "alert"  => "ra ra-aware",
                "douleur" => "ra ra-player-pain",
                "despair" => "ra ra-player-despair",
                "pyro" => "ra ra-player-pyromaniac",
                "tp" => "ra ra-player-teleport",*/
            ...
            "tete" => array(
                ...
                "knight-helmet" => "ra ra-knight-helmet",
                "helmet" => "ra ra-helmet",
                "horns" => "ra ra-horns",
            ),
            "torse" => array(
