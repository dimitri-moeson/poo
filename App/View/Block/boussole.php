    ...
    <div class="row btn-group">
        <?php foreach ($dev as $y => $val ){ ?>
            ...
            <?php if($x == 2 && $y == 2) { ?>
                ...
                <div class="col-xs-<?php echo $y%2 === 1 ? "3" : "6" ?>  btn btn-warning">
                    <?php echo $center ?>
                </div>

            <?php } else { ?>

                <button class="col-xs-<?php echo $y%2 === 1 ? "3" : "6" ?> btn btn-info" type="submit" name="coordonnees" value="<?php echo $val["x"] ?>|<?php echo $val["y"] ?>">
                    <?php echo $val["char"] ?>
                </button>
